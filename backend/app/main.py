...
from app.api.routes import auth, dashboard, foodwise, incidents, inventory, manual, ocr, pipeline, simulation, storage, suppliers
...
app.include_router(foodwise.router)
